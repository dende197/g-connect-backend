...
(function (root) {
    ...
    var DEMO_DATA = {
        // --------------------------------------------------------------------
        // 1. VOTI (A.S. 2026/2027 in corso + Storico A.S. 2025/2026 completo)
        // --------------------------------------------------------------------
        voti: [
            // === ANNO SCOLASTICO CORRENTE 2026/2027 (Settembre 2026) ===
            // Italiano
            { id: 'v26-ita-1', materia: 'Italiano', valore: 8, voto: 8, data: '2026-09-18', tipo: 'Orale', docente: 'Prof.ssa Bianchi', commento: 'Interrogazione su Dante e le origini della lingua volgare' },
            { id: 'v26-ita-2', materia: 'Italiano', valore: 7.5, voto: 7.5, data: '2026-09-25', tipo: 'Scritto', docente: 'Prof.ssa Bianchi', commento: 'Analisi del testo poetico e comprensione critica' },
            // Matematica (Include insufficienza per mostrare calcolo recupero e goal simulator)
            { id: 'v26-mat-1', materia: 'Matematica', valore: 7, voto: 7, data: '2026-09-15', tipo: 'Scritto', docente: 'Prof. Ferrari', commento: 'Verifica su domini di funzione e grafici deducibili' },
            { id: 'v26-mat-2', materia: 'Matematica', valore: 4.5, voto: 4.5, data: '2026-09-22', tipo: 'Scritto', docente: 'Prof. Ferrari', commento: 'Difficoltà nel calcolo dei limiti notevoli e asintoti' },
            { id: 'v26-mat-3', materia: 'Matematica', valore: 8, voto: 8, data: '2026-09-28', tipo: 'Orale', docente: 'Prof. Ferrari', commento: 'Ottimo recupero: dimostrazione del teorema di Weierstrass' },
            // Fisica (Altro voto basso per testare l'indicatore di attenzione)
            { id: 'v26-fis-1', materia: 'Fisica', valore: 5, voto: 5, data: '2026-09-16', tipo: 'Scritto', docente: 'Prof. Costa', commento: 'Esercizi su cinematica rotazionale ed energia' },
            { id: 'v26-fis-2', materia: 'Fisica', valore: 7, voto: 7, data: '2026-09-26', tipo: 'Orale', docente: 'Prof. Costa', commento: 'Buona esposizione delle leggi della termodinamica' },
            // Informatica
            { id: 'v26-inf-1', materia: 'Informatica', valore: 9, voto: 9, data: '2026-09-17', tipo: 'Pratico', docente: 'Prof. De Luca', commento: 'Sviluppo algoritmo di ordinamento e ricerca in laboratorio' },
            { id: 'v26-inf-2', materia: 'Informatica', valore: 8.5, voto: 8.5, data: '2026-09-24', tipo: 'Scritto', docente: 'Prof. De Luca', commento: 'Modello relazionale e query SQL complesse' },
            // Scienze Naturali
            { id: 'v26-sci-1', materia: 'Scienze Naturali', valore: 7, voto: 7, data: '2026-09-19', tipo: 'Orale', docente: 'Prof.ssa Romano', commento: 'Struttura della cellula e respirazione cellulare' },
            { id: 'v26-sci-2', materia: 'Scienze Naturali', valore: 6.5, voto: 6.5, data: '2026-09-27', tipo: 'Scritto', docente: 'Prof.ssa Romano', commento: 'Verifica su genetica mendeliana' },
            // Inglese
            { id: 'v26-ing-1', materia: 'Inglese', valore: 8.5, voto: 8.5, data: '2026-09-18', tipo: 'Orale', docente: 'Prof. Miller', commento: 'Fluency and accurate vocabulary discussing modern society' },
            { id: 'v26-ing-2', materia: 'Inglese', valore: 8, voto: 8, data: '2026-09-25', tipo: 'Scritto', docente: 'Prof. Miller', commento: 'Essay writing: argumentative structure on climate issues' },
            // Storia Triennio
            { id: 'v26-sto-1', materia: 'Storia Triennio', valore: 7.5, voto: 7.5, data: '2026-09-21', tipo: 'Orale', docente: 'Prof. Moretti', commento: 'Quadro socio-politico dell\'Europa moderna' },
            // Filosofia
            { id: 'v26-fil-1', materia: 'Filosofia', valore: 8, voto: 8, data: '2026-09-23', tipo: 'Orale', docente: 'Prof. Moretti', commento: 'Origine del pensiero occidentale: i presocratici e Socrate' },
            // Disegno e Storia Dell'Arte Triennio
            { id: 'v26-art-1', materia: 'Disegno e Storia Dell\'Arte Triennio', valore: 7.5, voto: 7.5, data: '2026-09-22', tipo: 'Pratico', docente: 'Prof.ssa Ricci', commento: 'Tavola n.1: assonometria isometrica di solidi composti' },
            { id: 'v26-art-2', materia: 'Disegno e Storia Dell\'Arte Triennio', valore: 7, voto: 7, data: '2026-09-29', tipo: 'Orale', docente: 'Prof.ssa Ricci', commento: 'Analisi architettonica e prospettica del Rinascimento' },
        ...
        tasks: [
            {
                ...
                subject: 'Matematica',
                due_date: '2026-09-08',
                text: 'Esercizi sui limiti notevoli e forme indeterminate pag. 134 n. 45, 48, 52.',
                done: false,
                source: 'argo'
            },
            {
